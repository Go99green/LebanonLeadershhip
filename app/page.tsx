...
const doItems = [
  {
    icon: Users,
    text: "Prioritize Relationship-Building (Wasta): Business is deeply personal. Never rush into a deal without first establishing trust through social interaction and shared meals.",
  },
  {
    icon: ShieldHalf,
    text: "Respect the Hierarchy: Acknowledge the most senior person in the room first; top-down decision-making is the norm.",
  },
  {
    icon: Ear,
    text: "High-Context Communication: Utilize and interpret indirect language to avoid \"loss of face.\" A \"no\" is rarely stated directly; leaders must listen for subtle cues.",
  },
  {
    icon: Award,
    text: "Emphasize Honor and Reputation: Avoid public criticism at all costs. Corrections and feedback must be handled privately to preserve the individual's honor.",
  },
  {
    icon: TrendingUp,
    text: "Navigate Economic Volatility: Be prepared for a decentralized, cash-reliant business environment and maintain acute awareness of currency fluctuations (World Bank, 2026).",
  },
];
      ...
      <div className="relative grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
        <div>
          ...
          <div className="mt-6 space-y-3 text-sm text-neutral-200">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3"><span className="font-semibold">Mount Lebanon</span> → identity and refuge communities</div>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.88fr_1.12fr]">
          <div className="rounded-xl border border-white/10 bg-white/[0.03] p-6 shadow-glow">
            ...
            <p className="mt-4 text-sm leading-7 text-neutral-300">
              {framework === "hall" ? (
                <>
                  <span className="text-tactical-orange font-bold">High-Context</span> communication means meaning is embedded in the physical context or internalized in the person, rather than explicitly stated. Hofstede’s{" "}
                  <span className="text-tactical-orange font-bold">Power Distance</span>: Lebanon scores high; hierarchies are accepted as a natural part of the social order, and authority is rarely challenged directly in business settings (Yahchouchi, 2026). Hofstede’s{" "}
                  <span className="text-tactical-orange font-bold">Collectivism</span>: High collectivism. The "in-group" (family and religious community) takes precedence over the individual, making loyalty paramount (Hofstede, 2021).
                </>
              ) : (
      ...
      >
        <div className="grid gap-8 lg:grid-cols-[0.82fr_1.18fr]">
          <div className="rounded-xl border border-white/10 bg-white/[0.03] p-6 shadow-glow">
            ...
            <p className="mt-3 text-sm leading-7 text-neutral-300">
              These origins reinforce <span className="text-tactical-orange font-bold">High-Context</span> communication and relationship-first leadership behaviors that later appear in organizational practices such as <span className="text-tactical-orange font-bold">Wasta</span> and <span className="text-tactical-orange font-bold">Paternalism</span>.
            </p>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            <div className="h-[360px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={leadershipBalance} margin={{ top: 10, right: 18, left: -18, bottom: 0 }}>
                  ...
                  <Line type="monotone" dataKey="localExpectation" stroke="#2F7C6A" strokeWidth={3} dot={false} />
          ...
          <div className="grid gap-6">
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.03] p-6 shadow-glow">
              ...
              <p className="mt-3 text-sm leading-7 text-neutral-300">
                Economy: The World Bank characterizes the current state as a "Fragile Rebound." Real GDP expanded by 3.5% in 2025, signaling a slow recovery from the 2019 financial crisis, operating heavily in a cash-based environment (World Bank, 2026). Politics: The government operates under <span className="text-tactical-orange font-bold">Confessionalism</span>, a power-sharing agreement where legislative and executive seats are distributed according to religious demographics, which heavily dictates resource distribution and institutional leadership (Policy Initiative, 2025).
              </p>
            </div>
          </div>
        </div>
            ...
            <FadeIn key={item.text} delay={index * 0.04}>
              <div className="rounded-xl border border-tactical-300/20 bg-tactical-500/10 p-5 shadow-glow transition-transform hover:scale-105">
                <div className="mb-3 flex items-center gap-3">
                  <div className="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-white/10 text-xs font-semibold">
                    0{index + 1}
                  </div>
                  <Icon className="h-5 w-5 text-tactical-orange" />
                </div>
                <p className="text-sm leading-7 text-tactical-100">{item.text}</p>
              </div>
            </FadeIn>
          )})}
        </div>
